...
postgre_con = BaseHook.get_connection('Test_conn')
...
with DAG(
    ...
    result_two_task = BashOperator(
        task_id='two_task', 
        bash_command=f"python3 /opt/airflow/dags/pg_read.py {postgre_con_host} {postgre_con_user} {postgre_con_pass} {postgre_con_port}"
        )
    wait_for_pg_insert_dag >> result_firs_task >> result_two_task
